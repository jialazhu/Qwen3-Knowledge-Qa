...
class MedicalAssistant:
    ...
    def show_sample_questions(self, scenario_type):
        ...
        if scenario_type in SAMPLE_QUESTIONS:
            print(f"\n📋 {MEDICAL_SCENARIOS.get(scenario_type, '江湖郎中咨询')} - 示例问题:")
            print("-" * 40)
...
def main():
    parser = argparse.ArgumentParser(description="江湖郎中助手 - 基于Qwen3-0.6B的智能江湖郎中咨询系统")
